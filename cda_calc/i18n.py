...
_MESSAGES: dict[str, dict[str, str]] = {
    "pl": {
        ...
        "chart_map_title": "Trasa (GPS)",
        "chart_map_route": "Trasa",
        "chart_map_segment": "Fragment {n}",
        "chart_map_start": "Start",
        "chart_map_end": "Koniec",
        "map_no_gps": "Brak danych GPS w wybranym segmencie.",
    ...
    "en": {
        ...
        "chart_map_title": "Route (GPS)",
        "chart_map_route": "Route",
        "chart_map_segment": "Segment {n}",
        "chart_map_start": "Start",
        "chart_map_end": "End",
        "map_no_gps": "No GPS data in the selected segment.",
